...
def test_create_user_with_unauthorized_user(runner, mocked_session, current_user_id, expected_exit_code, expected_output):
    ...
    result = runner.invoke(create_user, options, obj={"session": mocked_session, "current_user": current_user})
