...
class TestChangeClient:
    ...
    def test_change_client_contact(self, mock_current_session, mocked_session):
        ...
        with self.runner.isolated_filesystem():
            ...
            create_first_commercial_command = ["user", "create", "-n", first_commercial_name, "-e", first_commercial_email, "-r", "1",
            ...
            create_second_commercial_command = ["user", "create", "-n", second_commercial_name, "-e", second_commercial_email, "-r", "1",
            ...
            create_client_command = ["client", "create", "-e", client_email, "-n", client_name,
            ...
            change_client_contact_command = ["client", "contact", "-id", new_client.id, "-c", second_commercial.id]
            ...
            update_client_command = ["client", "update", "-id", new_client.id, "-com", new_company_name]
